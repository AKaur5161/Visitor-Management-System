...
public class ReportPDF {
	...
	public static Document createPDF(String file, String chosenDatefrom, String chosenDateto) {

		sDate = Date.valueOf(chosenDatefrom);
		lDate = Date.valueOf(chosenDateto);
	...
	private static void addMetaData(Document document) {
		...
		document.addAuthor("Visitor Detail");
	...
	private static void addTitlePage(Document document) throws DocumentException {
		...
		preface.add(new Paragraph("Visitor", TIME_ROMAN));
	...
	private static void createTable(Document document) throws DocumentException {
		...
		cell.setPhrase(new Phrase("ContactPersonName", font));
		table.addCell(cell);
		...
		try {
			...
			String query = "select v.ID, v.Name, v.Purpose, v.ContactPersonName from Visitor v where v.Date between :sDate AND :lDate ";
			Query qry = entity.createQuery(query).setParameter("sDate", sDate).setParameter("lDate", lDate);
